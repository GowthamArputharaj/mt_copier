...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="container-fluid p-0 m-0">
      <div class="bg-success text-center text-white">
        <h1>Copier Management</h1>
        @if(Session::has('swal_success'))
          <div class="alert alert-success" role="alert" >
            {{Session::get('swal_success')}}
            <button type="button" class="btn-close float-end " data-bs-dismiss="alert" data-bs-target="#my-alert" aria-label="Close"></button>
          </div>
        @endif
        @if(Session::has('swal_error'))
          <div class="alert alert-danger" role="alert">
            {{Session::get('swal_error')}}
            <button type="button" class="btn-close float-end " data-bs-dismiss="alert" data-bs-target="#my-alert" aria-label="Close"></button>
          </div>
        @endif
      </div>
